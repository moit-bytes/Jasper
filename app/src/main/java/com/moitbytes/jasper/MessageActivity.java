...
import com.moitbytes.jasper.Fragments.APIService;
import com.moitbytes.jasper.Model.Chat;
import com.moitbytes.jasper.Notifications.Client;
import com.moitbytes.jasper.Notifications.Data;
import com.moitbytes.jasper.Notifications.MyResponse;
import com.moitbytes.jasper.Notifications.Sender;
import com.moitbytes.jasper.Notifications.Token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    {
                        profile_image.setImageResource(R.mipmap.jasper);
                    }
                    else {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.mipmap.jasper,username+": "+message,"New Message",
                            userid);
