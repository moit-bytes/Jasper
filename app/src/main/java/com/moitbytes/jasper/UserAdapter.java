...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    private List<JasperUser> mUsers;
    private boolean ischat;

    String theLastMessage;
    public UserAdapter(Context mContext, List<JasperUser> mUsers, boolean ischat)
    {
        this.mUsers = mUsers;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final JasperUser user = mUsers.get(position);
        ...
        {
            holder.profile_image.setImageResource(R.mipmap.jasper);
        }
        else
        {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(firebaseUser != null && user_id != null)
                    {
